24.04.2020 20:14:15 Results of ResultWriter 'Write as Text' [1]: 
24.04.2020 20:14:15 JRIP rules:
===========

(przedzial_nr.employed = '(-inf-5029.725]') and (pdays <= 16) and (campaign <= 1) => y=yes (880.0/186.0)
(przedzial_nr.employed = '(-inf-5029.725]') and (pdays <= 27) and (poutcome = success) => y=yes (742.0/213.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (poutcome = nonexistent) and (Rok >= 2010) and (campaign <= 1) => y=yes (517.0/184.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (przedzial_cons.conf.idx = '(-42.833333--38.85]') and (poutcome = nonexistent) => y=yes (234.0/104.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (poutcome = nonexistent) and (przedzial_cons.conf.idx = '(-34.866667--30.883333]') and (education = basic.4y) => y=yes (27.0/5.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (przedzial_cons.conf.idx = '(-34.866667--30.883333]') and (poutcome = nonexistent) and (przedzial_wiek = '(44-57.5]') and (marital = married) => y=yes (39.0/16.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (przedzial_cons.conf.idx = '(-42.833333--38.85]') and (przedzial_wiek = '(57.5-71]') => y=yes (44.0/14.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (poutcome = nonexistent) and (przedzial_cons.price.idx = '(93.911667-94.339333]') and (przedzial_wiek = '(44-57.5]') => y=yes (22.0/4.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (przedzial_cons.conf.idx = '(-42.833333--38.85]') and (pdays <= 18) => y=yes (18.0/4.0)
(Rok >= 2009) and (przedzial_nr.employed = '(5029.725-5095.85]') and (pdays <= 15) => y=yes (232.0/99.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (previous <= 1) and (marital = single) and (kategorie nieliczbowe = technician) => y=yes (87.0/42.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (przedzial_cons.conf.idx = '(-34.866667--30.883333]') and (contact = telephone) and (month = apr) => y=yes (38.0/6.0)
(Rok >= 2009) and (przedzial_nr.employed = '(-inf-5029.725]') and (contact = cellular) and (previous <= 1) and (przedzial_czas rozmowy = '(1229.5-2459]') and (Rok >= 2010) => y=yes (16.0/0.0)
 => y=no (40292.0/3657.0)

Number of Rules : 14

24.04.2020 20:14:15 if przedzial_nr.employed = '(5161.975-inf)' then no  (26351 / 1339)
